...
public class Receiver {
    ...
    private static void generatePair() throws Exception{
        ...
        FileOutputStream fos = new FileOutputStream("publicKeyB");
        ...
        fos = new FileOutputStream("privateKeyB");
    ...
    private static void generateMAC() throws Exception {
        ...
        try (FileInputStream in = new FileInputStream("MAC Key")) {
            ...
            verifyMAC("MAC Output A", macString);
        }
    ...
    private static void createMACKey () throws Exception {
        ...
        try (FileInputStream in = new FileInputStream("MAC Key")) {
            ...
            FileWriter macOut = new FileWriter("MAC Output B");
    ...
    private static void AESencrypt() throws Exception {
        ...
        //Print to file
        FileWriter fos = new FileWriter("MessageB");
    ...
    private static void AESdecrypt () throws Exception {
        ...
        FileReader fis = new FileReader("MessageA");
        ...
        FileWriter fos = new FileWriter("OutputMessageA");
    ...
    public static void main(String[] args) throws Exception{
        ...
        while(choice != -1){
            ...
            privateKeyB = getPrivKeyFromFile("privateKeyB");
            switch (choice){
                case 1:
                    //Generate new keys
                    generatePair();
                ...
                case 2:
                    ...
                    fos.write(RSAencrypt(secretKey, publicKeyA));
                    fos.close();
                    createMACKey();
                    break;
                case 3:
    ...
    static protected PrivateKey privateKeyB;
